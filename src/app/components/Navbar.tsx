...
const Navbar = () => {
  ...
  return (
    <div className="relative">
      <nav className=" bg-slate-900 bg-opacity-90 flex justify-between items-center px-[5%] sm:px-[10%] py-10 fixed top-0 w-full animate-[fadeUp_2s_ease-out]">
      ...
      {showMenu && (
        <div
          ...
          className="h-screen w-screen grid place-content-center justify-items-center gap-10 absolute bg-slate-950 bg-opacity-80 text-xl text-white z-10 "
        >
          <Link href="/">Home</Link>
          <Link href="/expertise">Expertise</Link>
          <Link href="/contact">Contact</Link>
